...
class DataLoader(object):
    ...
    def __init__(self, cfg):
        ...
        self.height, self.width, self.channel = cfg.height, cfg.width, cfg.channel
        self.project_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
        self.train_file = self.project_path + '/data/train_2d'
        self.valid_file = self.project_path + '/data/test_2d.h5'
        # self.test_file = '/home/cougarnet.uh.edu/amobiny/Downloads/organ_segmentation/data/test_2d.h5'
        self.test_file = '/home/cougarnet.uh.edu/pyuan2/Projects2019/organ_segmentation/data/test_2d.h5'
